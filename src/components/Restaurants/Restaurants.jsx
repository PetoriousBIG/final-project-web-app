        ...
        <div className="container">
          <div className="row gy-5">
            {restaurants.map((restaurant, index) => (
              <div className="col-xl-3 col-md-6 mb-4" data-aos="fade-up" data-aos-delay={200 * (index % 4)} key={restaurant.rid}>
                <div className="restaurant-box">
                  <div className="restaurant-img">
                    <img src={`assets/img/restaurants/restaurant-${restaurant.rid}.jpg`} className="img-fluid" alt={restaurant.name} />
                  </div>
                  <div className="meta">
                  ...
                  <Link to={`/restaurant/${restaurant.rid}`} className="more-info stretched-link">
