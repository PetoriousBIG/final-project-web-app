...
const userRole = 'owner'; // Change this to 'user', 'owner', or 'chef' to see different sections
              ...
              <SwiperSlide>
                <div className="testimonial-item">
                  <p>
                    ...
                    <span>
                      Absolutely loved the food and ambiance. Highly recommend
                      the vegan burger!(comment from this user)
                    </span>
                    <i className="bi bi-quote quote-icon-right" />
                  </p>
                  <img
                    src="assets/img/restaurants/restaurant-1.jpg"
              ...
              <SwiperSlide>
                <div className="testimonial-item">
                  <p>
                    <i className="bi bi-quote quote-icon-left" />
                    <span>
                      Great place for a healthy meal, but the service was a bit
                      slow.
                    </span>
                    <i className="bi bi-quote quote-icon-right" />
                  </p>
                  <img
                    src="assets/img/restaurants/restaurant-2.jpg"
                    className="testimonial-img"
              ...
              <SwiperSlide>
                <div className="testimonial-item">
                  <p>
                    <i className="bi bi-quote quote-icon-left" />
                    <span>
                      The vegan pizza was fantastic, but the place was a bit
                      crowded.
                    </span>
                    <i className="bi bi-quote quote-icon-right" />
                  </p>
                  <img
                    src="assets/img/restaurants/restaurant-3.jpg"
                    className="testimonial-img"
                    alt="The Vegan Table"
                  />
              ...
              <SwiperSlide>
                <div className="testimonial-item">
                  <p>
                    <i className="bi bi-quote quote-icon-left" />
                    <span>
                      Best vegan dishes I've ever had. The desserts are to die
                      for!
                    </span>
                    <i className="bi bi-quote quote-icon-right" />
                  </p>
                  <img
                    src="assets/img/restaurants/restaurant-4.jpg"
                    className="testimonial-img"
                    alt="Purely Plant-Based"
                  />
              ...
              <SwiperSlide>
                <div className="testimonial-item">
                  <p>
                    <i className="bi bi-quote quote-icon-left" />
                    <span>
                      Vegan Delight is a cozy place offering a wide range of
                      vegan delights.
                    </span>
                    <i className="bi bi-quote quote-icon-right" />
                  </p>
              ...
              <SwiperSlide>
                <div className="testimonial-item">
                  <p>
                    <i className="bi bi-quote quote-icon-left" />
                    <span>
                      Green Garden Bistro specializes in fresh and organic vegan
                      cuisine.
                    </span>
                    <i className="bi bi-quote quote-icon-right" />
                  </p>
